...
(function () {
  ...
  if (bldgViewSwitch && bldgViewCarousel && bldgViewMap && bldgMapEl) {
    ...
    const BUILDINGS = [
      { name: 'The Loren',                 district: 'Lady Bird Lake Edge',         href: '/buildings/loren',         lat: 30.2641, lng: -97.7564 },
      { name: 'Four Seasons Residences',   district: 'Downtown Core',               href: '/buildings/fourseasons',   lat: 30.2617, lng: -97.7423 },
      { name: 'Austin Proper Residences',  district: 'Market District',             href: '/buildings/proper',        lat: 30.2662, lng: -97.7501 },
      { name: 'The Austonian',             district: 'Downtown Core',               href: '/buildings/austonian',     lat: 30.2646, lng: -97.7444 },
      { name: 'The Independent',           district: 'Market District',             href: '/buildings/independent',   lat: 30.2678, lng: -97.7512 },
      { name: 'W Austin Residences',       district: 'Downtown Core',               href: '/buildings/wresidences',   lat: 30.2657, lng: -97.7466 },
      { name: 'The Shore',                 district: 'Rainey District',             href: '/buildings/shore',         lat: 30.2596, lng: -97.7393 },
      { name: '70 Rainey',                 district: 'Rainey District',             href: '/buildings/70rainey',      lat: 30.2586, lng: -97.7392 },
      { name: '44 East Avenue',            district: 'Rainey District',             href: '/buildings/44east',        lat: 30.2560, lng: -97.7390 },
      { name: 'Vesper ATX',                district: 'Rainey District',             href: '/buildings/vesper',        lat: 30.2580, lng: -97.7381 },
      { name: 'The Modern Austin',         district: 'Rainey District',             href: '/buildings/modern',        lat: 30.2604, lng: -97.7390 },
      { name: 'Natiivo Austin',            district: 'Rainey District',             href: '/buildings/natiivo',       lat: 30.2564, lng: -97.7389 },
      { name: 'Bridges on The Park',       district: 'Lady Bird Lake Edge',         href: '/buildings/bridges',       lat: 30.2632, lng: -97.7573 },
      { name: 'Barton Place',              district: 'Lady Bird Lake Edge',         href: '/buildings/bartonplace',   lat: 30.2623, lng: -97.7615 },
      { name: 'Milago',                    district: 'Lady Bird Lake Edge',         href: '/buildings/milago',        lat: 30.2574, lng: -97.7394 },
      { name: 'Fifth & West',              district: 'Market District',             href: '/buildings/fifthwest',     lat: 30.2694, lng: -97.7508 },
      { name: 'Seaholm Residences',        district: 'Market District',             href: '/buildings/seaholm',       lat: 30.2672, lng: -97.7521 },
      { name: '360 Condominiums',          district: 'Second Street District',      href: '/buildings/360',           lat: 30.2674, lng: -97.7497 },
      { name: 'Spring Condominiums',       district: 'Market District',             href: '/buildings/spring',        lat: 30.2690, lng: -97.7541 },
      { name: 'The Linden',                district: 'Downtown Core',               href: '/buildings/linden',        lat: 30.2794, lng: -97.7421 },
      { name: 'Sabine on 5th',             district: 'Downtown Core',               href: '/buildings/sabine',        lat: 30.2655, lng: -97.7361 },
      ...
      { name: 'The Colorfield',            district: 'Clarksville/Old West Austin', href: '/buildings/colorfield',    lat: 30.2761, lng: -97.7532 },
      { name: 'The Belvedere',             district: 'Clarksville/Old West Austin', href: '/buildings/belvedere',     lat: 30.2718, lng: -97.7614 },
      { name: 'Brazos Place',              district: 'Downtown Core',               href: '/buildings/brazosplace',   lat: 30.2699, lng: -97.7408 },
    ];
