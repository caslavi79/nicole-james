...
(function () {
  ...
  if (bldgViewSwitch && bldgViewCarousel && bldgViewMap && bldgMapEl) {
    ...
    const BUILDINGS = [
      { name: 'The Loren',                 district: 'Lady Bird Lake Edge',         href: 'buildings/loren.html',         lat: 30.2641, lng: -97.7564 },
      { name: 'Four Seasons Residences',   district: 'Downtown Core',               href: 'buildings/fourseasons.html',   lat: 30.2617, lng: -97.7423 },
      { name: 'Austin Proper Residences',  district: 'Market District',             href: 'buildings/proper.html',        lat: 30.2662, lng: -97.7501 },
      ...
      { name: 'W Austin Residences',       district: 'Downtown Core',               href: 'buildings/wresidences.html',   lat: 30.2657, lng: -97.7466 },
      ...
      { name: 'Bridges on The Park',       district: 'Lady Bird Lake Edge',         href: 'buildings/bridges.html',       lat: 30.2632, lng: -97.7573 },
      { name: 'Barton Place',              district: 'Lady Bird Lake Edge',         href: 'buildings/bartonplace.html',   lat: 30.2623, lng: -97.7615 },
      ...
      { name: '5 Fifty Five',              district: 'Downtown Core',               href: 'buildings/555.html',           lat: 30.2654, lng: -97.7378 },
